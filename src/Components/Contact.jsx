          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            {submitted ? (
              <div className="text-center py-10">
                ...
                <p className="mt-2 text-gray-600">Your message has been received. We'll get back to you soon!</p>
                <button 
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">contact@yourblog.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">123 Blog Street, Content City, 90210</p>
                </div>
              </div>
